...
from nnunetpsma.paths import nnUNet_preprocessed, nnUNet_raw
from nnunetpsma.preprocessing.cropping.cropping import crop_to_nonzero
from nnunetpsma.preprocessing.resampling.default_resampling import compute_new_shape
...
class DefaultPreprocessor(object):
    ...
    def _normalize(self, data: np.ndarray, seg: np.ndarray, configuration_manager: ConfigurationManager,
        ...
        for c in range(data.shape[0]):
            ...
            normalizer_class = recursive_find_python_class(join(nnunetpsma.__path__[0], "preprocessing", "normalization"),
                                                           scheme,
                                                           'nnunetpsma.preprocessing.normalization')
...
def example_test_case_preprocessing():
    ...
    input_images = ['/home/isensee/drives/e132-rohdaten/nnunetpsma/Dataset219_AMOS2022_postChallenge_task2/imagesTr/amos_0600_0000.nii.gz', ]  # if you only have one channel, you still need a list: ['case000_0000.nii.gz']
