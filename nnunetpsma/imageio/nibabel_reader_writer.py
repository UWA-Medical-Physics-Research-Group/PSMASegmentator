...
class NibabelIO(BaseReaderWriter):
    ...
    IMPORTANT: Run nnunetpsma_plot_overlay_pngs to verify that this did not destroy the alignment of data and seg!
    """
    ...
    def read_images(self, image_fnames: Union[List[str], Tuple[str, ...]]) -> Tuple[np.ndarray, dict]:
        ...
        if not self._check_all_same_array(original_affines):
            ...
            print('Image files:')
            print(image_fnames)
            print('It is up to you to decide whether that\'s a problem. You should run nnunetpsma_plot_overlay_pngs to verify '
