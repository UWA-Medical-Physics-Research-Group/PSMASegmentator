    ...
    try:
        ...
        if overwrite_existing or not isfile(data_npy):
            try:
                ...
                print(f"Unable to open preprocessed file {npz_file}. Rerun nnunetpsma_preprocess!")
                raise e
        ...
        if verify_npy:
            try:
                ...
                if fail_ctr < 2:
                    ...
                    raise RuntimeError("Unable to fix unpacking. Please check your system or rerun nnunetpsma_preprocess")
