...
from nnunetpsma.experiment_planning.dataset_fingerprint.fingerprint_extractor import DatasetFingerprintExtractor
from nnunetpsma.experiment_planning.experiment_planners.default_experiment_planner import ExperimentPlanner
from nnunetpsma.experiment_planning.verify_dataset_integrity import verify_dataset_integrity
from nnunetpsma.paths import nnUNet_raw, nnUNet_preprocessed
from nnunetpsma.utilities.dataset_name_id_conversion import convert_id_to_dataset_name
...
from nnunetpsma.utilities.utils import get_filenames_of_train_images_and_targets
...
def extract_fingerprints(dataset_ids: List[int], fingerprint_extractor_class_name: str = 'DatasetFingerprintExtractor',
                         ...
                         clean: bool = True, verbose: bool = True):
    """
    clean = False will not actually run this. This is just a switch for use with nnunetpsma_plan_and_preprocess where
    we don't want to rerun fingerprint extraction every time.
    """
    fingerprint_extractor_class = recursive_find_python_class(join(nnunetpsma.__path__[0], "experiment_planning"),
