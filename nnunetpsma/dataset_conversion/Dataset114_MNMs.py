...
from nnunetpsma.dataset_conversion.Dataset027_ACDC import make_out_dirs
from nnunetpsma.dataset_conversion.generate_dataset_json import generate_dataset_json
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "(2) Run `nnunetpsma_plan_and_preprocess -d 114 --verify_dataset_integrity`\n"
        "(3) Start training, but stop after initial splits are created: `nnunetpsma_train 114 2d 0`\n"
