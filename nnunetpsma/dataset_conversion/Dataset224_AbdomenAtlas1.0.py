...
if __name__ == '__main__':
    ...
    2. Run planning and preprocessing: `nnunetpsma_plan_and_preprocess -d 224 -npfp 64 -np 64 -c 3d_fullres -pl 
    ...
    constraints.
    3. Run training with `nnunetpsma_train 224 3d_fullres all -p nnUNetResEncUNetLPlans_torchres`. 24GB VRAM required, 
